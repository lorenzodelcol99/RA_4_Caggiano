...
% pseudo real time out-of-sample forecast and news
% DFM estimated by EM algorithm
% written for 
...
% loading the details for the forecast and news
StartEst = P.StartEst;
StartEv  = P.StartEv;
EndEv    = P.EndEv ;
Qnews = P.Qnews; % quarter to be forecast
SerNews = P.SerNews; % series to be forecast
