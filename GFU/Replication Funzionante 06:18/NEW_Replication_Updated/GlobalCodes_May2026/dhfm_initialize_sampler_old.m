% Preliminary PC analysis [F,G,H,FH,FX,GX,K_F,K_G,K_H]=do_EM_level4(bigX,Bsub)
[F_em,G_em,H_em,FH_em,FX_em,GX_em,K_F_em,K_G_em,K_H_em]=do_EM_level4(bigZ_ns,Bsub);
