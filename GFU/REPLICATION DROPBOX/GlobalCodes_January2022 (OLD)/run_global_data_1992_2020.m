...
clear all
addpath(genpath('/Users/lorenzodelcol/Desktop/RA/REPLICATION DROPBOX/'))

%data=xlsread('globa_data_estimation_June2019.xlsx','2019');% dataset 1992-2019
% LORENZO data=xlsread('cc_globalfactor_1992M72020M5.xlsx');% dataset 1992-2020

% Usiamo readmatrix che è più moderno e robusto su Mac
data_raw = readmatrix('/Users/lorenzodelcol/Desktop/RA/REPLICATION DROPBOX/cc_globalfactor_1992M72020M5.xlsx');

% Scartiamo la prima colonna (le Date) per riallineare tutti gli indici!
data = data_raw(:, 2:end);
%%% FINE  LORENZO
...
save('Test2_42countries_92M720M5','bigZ_ns');
m = matfile('Test2_42countries_92M720M5','Writable',true);
